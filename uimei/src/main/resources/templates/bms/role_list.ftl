	...
	<body>
			...
			<blockquote class="layui-elem-quote">
		       ...
		       <a href="javascript:;" class="layui-btn layui-btn-small" id="search">
				 ...
				 <a href="${request.contextPath}/backpage/admin/role_to_input" class="layui-btn layui-btn-small" >
					...
					<table class="site-table table-hover">
						...
						<#list page.list as role>
						    <tr>
								...
								<td>
									<a href="${request.contextPath}/backpage/admin/role_to_input?id=${role.id}"  class="layui-btn layui-btn-mini">编辑</a>
			...
			layui.use(['icheck', 'laypage','layer'], function() {
				...
				laypage({
					...
					jump: function(obj, first) {
						...
						if(!first) {
						 $.ajax({
				           url:'${request.contextPath}/backpage/admin/role_getlist',
				           type:'post',
				           ...
				           success:function(data) { 
                            ...
                            $.each(data.list,function(i,val){
								...
								str += '<td>'
								str += '<a href="${request.contextPath}/backpage/admin/role_to_input?id='+val.id+'"  class="layui-btn layui-btn-mini">编辑</a>'
